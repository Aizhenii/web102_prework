...
contributionsCard.innerHTML = `
    <p class="card-total">${totalContributions.toLocaleString()}</p>
`;
...
raisedCard.innerHTML = `
    <p class="card-total">${totalRaised.toLocaleString()}</p>
`;
...
gamesCard.innerHTML = `
    <p class="card-total">${totalGames.toLocaleString()}</p>
`;
...
const unfundedString = `A total of ${totalContributions} has been raised for ${totalGames - numUnfundedGames}. Currently, ${
    numUnfundedGames === 1 ? "1 game" : `${numUnfundedGames} games`
...
firstGameElement.innerHTML = `
    <p class="card-total">${firstGame.name}</p>
`;
